...
use frame_support::{
	...
	traits::{ChangeMembers, EnsureOrigin, Get, InitializeMembers, Contains, GetMembers},
...
impl<T: Trait<I>, I: Instance> GetMembers<T::AccountId> for Module<T, I> {
	fn get_members() -> Vec<T::AccountId>{
		<Members<T, I>>::get()
	}

	fn get_members_len() -> u32{
