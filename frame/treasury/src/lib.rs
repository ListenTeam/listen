...
pub trait Trait<I=DefaultInstance>: frame_system::Trait {
	...
	type CreateOrigin: OnUnbalanced<PositiveImbalanceOf<Self, I>>;
...
decl_event!(
		...
		<T as frame_system::Trait>::Hash,
	{
		...
		MintForTreasury(AccountId, Balance),
	}
);
...
decl_module! {
		...
		where origin: T::Origin
	{
		...
		/// 给国库铸币
		#[weight = 10000 ]
		fn mint_for_treasury(origin, value: BalanceOf<T, I>) {
			ensure_root(origin)?;
			T::CreateOrigin::on_unbalanced(T::Currency::deposit_creating(&Self::account_id(), value));
			Self::deposit_event(RawEvent::MintForTreasury(Self::account_id(), value));
		}
